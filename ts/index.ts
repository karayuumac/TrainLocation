...
class Path {
  ...
  public x_pos(moment: moment.Moment, direction: Direction) {
...
class Time {
  ...
  public static from(moment: moment.Moment): Time {
...
type Running_day = (moment: moment.Moment) => boolean
...
class Train {
  ...
  setTrainObj(moment: moment.Moment): any {
  ...
  updateObj(moment: moment.Moment) {
    const info = this.getInfo(moment);
    if (info == null) {
      return
    }
  ...
  private getInfo(now: moment.Moment): Info | null {
